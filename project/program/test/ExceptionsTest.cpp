...
BOOST_FIXTURE_TEST_SUITE(ExceptionsTest,TestSuiteExceptionFixture)
    ...
    BOOST_AUTO_TEST_CASE(CurrentAccountExceptionTest) {
        ClientPtr owner = std::make_shared<Client>("01234567891", "Marcin", "Nowak",
                                                   boost::posix_time::ptime(boost::gregorian::date(2000, 5, 13)));
        BOOST_CHECK_NO_THROW(AccountPtr currentAccountError = std::make_shared<CurrentAccount>(owner, 1,0,boost::posix_time::not_a_date_time));
        BOOST_CHECK_THROW(AccountPtr currentAccountError = std::make_shared<CurrentAccount>(nullptr, 1,0,boost::posix_time::not_a_date_time),AccountException::exception);
        BOOST_CHECK_THROW(AccountPtr currentAccountError = std::make_shared<CurrentAccount>(owner, 9000,0,boost::posix_time::not_a_date_time),AccountException::exception);
        BOOST_CHECK_THROW(AccountPtr currentAccountError = std::make_shared<CurrentAccount>(owner, -1,0,boost::posix_time::not_a_date_time),AccountException::exception);
    }
    BOOST_AUTO_TEST_CASE(SavingsAccountExceptionTest) {
        ClientPtr owner = std::make_shared<Client>("01234567891", "Marcin", "Nowak",
                                                   boost::posix_time::ptime(boost::gregorian::date(2000,5,13)));
        AccountPtr acc = std::make_shared<CurrentAccount>(owner,1,0,boost::posix_time::not_a_date_time);
        BOOST_CHECK_NO_THROW(AccountPtr savingsAccountError = std::make_shared<SavingsAccount>(owner,2, acc,interest,0,boost::posix_time::not_a_date_time,boost::posix_time::not_a_date_time));
        BOOST_CHECK_THROW(AccountPtr savingsAccountError = std::make_shared<SavingsAccount>(nullptr,2,acc,interest,0,boost::posix_time::not_a_date_time,boost::posix_time::not_a_date_time),AccountException::exception);
        BOOST_CHECK_THROW(AccountPtr savingsAccountError = std::make_shared<SavingsAccount>(owner,2,nullptr,interest,0,boost::posix_time::not_a_date_time,boost::posix_time::not_a_date_time),AccountException::exception);
        BOOST_CHECK_THROW(AccountPtr savingsAccountError = std::make_shared<SavingsAccount>(owner,9000,acc,interest,0,boost::posix_time::not_a_date_time,boost::posix_time::not_a_date_time),AccountException::exception);
        BOOST_CHECK_THROW(AccountPtr savingsAccountError = std::make_shared<SavingsAccount>(owner,-1,acc,interest,0,boost::posix_time::not_a_date_time,boost::posix_time::not_a_date_time),AccountException::exception);
        BOOST_CHECK_THROW(AccountPtr savingsAccountError = std::make_shared<SavingsAccount>(owner,1,acc,nullptr,0,boost::posix_time::not_a_date_time,boost::posix_time::not_a_date_time),AccountException::exception);
    }
    ...
    BOOST_AUTO_TEST_CASE(TransactionExceptionTest) {
        ...
        AccountPtr acc1 = std::make_shared<CurrentAccount>(client1,1,0,boost::posix_time::not_a_date_time);
