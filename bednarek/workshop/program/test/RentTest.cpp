...
BOOST_FIXTURE_TEST_SUITE(TestSuiteRent, TestSuiteRentFixture)
    ...
    BOOST_AUTO_TEST_CASE(RentTimesGivenConstructorTests) {
        Rent rent1(1,client,vehicle,boost::posix_time::ptime(boost::gregorian::date(2021,5,13),boost::posix_time::hours(9)),vehicle->getBasePrice());
    ...
    BOOST_AUTO_TEST_CASE(RentDaysNotEndedTests) {
        Rent rent(1,client,vehicle,boost::posix_time::ptime(boost::gregorian::date(2021,4,6),boost::posix_time::hours(10)),vehicle->getBasePrice());
