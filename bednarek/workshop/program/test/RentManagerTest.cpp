...
BOOST_FIXTURE_TEST_SUITE(TestSuiteRentManager,TestSuiteRentManagerFixture)
    ...
    rentmanager.rentVehicle(1,clientmanager.getClient("123123123"),vehiclemanager.getVehicle("EL12345"),boost::posix_time::not_a_date_time);
    ...
    BOOST_AUTO_TEST_CASE(GetAllClientsRentsTests) {
        ...
        rentmanager.rentVehicle(1,clientmanager.getClient("123123123"),vehiclemanager.getVehicle("EL12345"),boost::posix_time::not_a_date_time);
        rentmanager.rentVehicle(2,clientmanager.getClient("123123123"),vehiclemanager.getVehicle("EL12346"),boost::posix_time::not_a_date_time);
    ...
    BOOST_AUTO_TEST_CASE(checkClientRentBalanceTest){
        ...
        vehiclemanager.registerBicycle("EL12345",100);
        vehiclemanager.registerBicycle("EL12346",200);
        rentmanager.rentVehicle(1,clientmanager.getClient("123123123"),vehiclemanager.getVehicle("EL12345"),boost::posix_time::ptime(boost::gregorian::date(2021,4,26),boost::posix_time::hours(10)));
        rentmanager.rentVehicle(2,clientmanager.getClient("123123123"),vehiclemanager.getVehicle("EL12346"),boost::posix_time::ptime(boost::gregorian::date(2021,4,26),boost::posix_time::hours(10)));
    ...
    BOOST_AUTO_TEST_CASE(changeClientTypeDefaultTest){
        ...
        rentmanager.rentVehicle(1,clientmanager.getClient("123123123"),vehiclemanager.getVehicle("EL1"),boost::posix_time::ptime(boost::gregorian::date(2021,4,26),boost::posix_time::hours(10)));
        BOOST_TEST(rentmanager.checkClientRentBalance(clientmanager.getClient("123123123"))==0);
